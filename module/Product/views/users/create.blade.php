            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('product.users.store') }}" class="form-horizontal"
                        ...
                        <!-- Name -->
                            ...
                            <!-- PIN -->
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-sm-3">Password<sup class="text-danger">*</sup>
                                    :</label>
                                <div class="col-md-5 col-sm-5">
                                    <code>Default password: 12345678</code>

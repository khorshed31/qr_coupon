            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <form method="POST" action="{{ route('product.products.update', $product->id) }}" class="form-horizontal"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="col-md-9 col-sm-9">
                                            <img class="img-thumbnail" id="blah" width="220" src="{{ asset($product->image) ?? asset('assets/images/default.png') }}">
                                        </div>
                                    </div>
